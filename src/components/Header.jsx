...
function Header(props) {
  ...
  return (
    <header className="content-header  top-0 left-0 w-full  min-h-[var(--header-height-mobile)] lg:min-h-[var(--header-height-desktop)]">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex mt-5">
                ...
                <Link to="/" className="mr-3 hidden md:flex">
                  <h1 className='sr-only md:not-sr-only"'>United Traktors</h1>
                  <img
                    src={require("../assets/images/united_logo.png")}
                    alt="..."
                    width="283"
                    height="60"
                  />
              ...
              <div className="flex items-end">
                <div className=" menu-nav items-end">
                  <LightTooltip
                    title="Selamat datang Sastromenggolo, AYO submit innovation kamu Sekarang"
                    placement="left"
                    arrow
                  >
                    <Button>
                      <img src={Notifikasi} alt="..." width="36" height="36" />
                    </Button>
                  </LightTooltip>
                </div>
                <div className=" menu-nav items-end">
                ...
                <div className="hidden md:grid">
                  ...
                  >
                    <img src={Profil} alt="..." width="36" height="36" />
