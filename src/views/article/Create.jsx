  ...
  <section className='hidden md:flex'>
      ...
      <section className='pt-10'>
        ...
        <div className='flex flex-col w-4/12'>
          ...
          <CustomInput aria-label="Search" placeholder="Ketik yang ingin dicari" type="file"/>
            ...
            <span className='pb-3 font-semibold'>Search</span>
          <div>
            <CustomInput aria-label="Search" placeholder="Ketik yang ingin dicari" type="search"/>
            </div>
      </div>
        </div>
